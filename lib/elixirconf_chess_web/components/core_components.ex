defmodule ElixirconfChessWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(ElixirconfChessWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(ElixirconfChessWeb.Gettext, "errors", msg, opts)
    # end
