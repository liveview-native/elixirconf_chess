...
config :elixirconf_chess, ElixirconfChessWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [
    formats: [html: ElixirconfChessWeb.ErrorHTML, json: ElixirconfChessWeb.ErrorJSON],
    layout: false
  ],
...
config :live_view_native, LiveViewNativeSwiftUi.Platform, app_name: "ElixirConf Chess"
